...
if (document.querySelector('.useful__container')) {
...
if (document.querySelector('.useful__wrapper-item')) {
...
const iso2 = new (isotope_layout__WEBPACK_IMPORTED_MODULE_0___default())('.result__list', {
  itemSelector: '.result__item',
  masonry: {
    // columnWidth: 100,
    horizontalOrder: true,
    percentPosition: true,
...
const tabsProcedure = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('procedure-service');
